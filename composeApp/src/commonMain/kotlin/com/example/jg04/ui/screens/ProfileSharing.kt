...
fun ShareProfileScreen(
    ...
    val qrPainter = rememberQrKitPainter(data = endpointId)
    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    text = "Scan with the Add-Contact Scanner:",
                ...
                Box(
                    ...
                    Image(
                        painter = qrPainter,
                        contentDescription = "EndpointID QR code",
            ...
            Column(
                ...
                Text(
                    text = "Or copy EndpointId directly:",
                    textAlign = TextAlign.Center,
